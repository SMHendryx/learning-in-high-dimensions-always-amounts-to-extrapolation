# -*- coding: utf-8 -*-
"""deep_interpolation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1m1aYaQ8sa5PfbTRpwfC_thTpeQuHDoIB

# Deep Interpolation Experiments

In this notebook, we want to reproduce recent findings from https://arxiv.org/pdf/2110.09485.pdf

And in particular, look at interpolation as a function of the embedding dimension.
"""
...
Note that they don't define convex hulls per class, which we typically care more about in practice, but to start, we'll just define one convex hull for the entire training set regardless of class.
